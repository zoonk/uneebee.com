...
export default function EditorFeatures() {
  return (
    <div className="overflow-hidden mt-4 bg-indigo-50 rounded-lg py-24 sm:py-32">
          ...
          <div className="lg:pr-8">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                UneeBee lets you quickly build lessons that go beyond watching
                videos. Bring your content to life with real-world scenarios,
                making it easy to create content that’s interactive and
                impactful. Lead your audience through choices that matter,
                fostering a deeper understanding with each step.
              </p>
