...
export default function EditorFeatures() {
  return (
    <div className="overflow-hidden mx-auto grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 max-w-7xl mt-4 px-6 lg:px-8 bg-indigo-50 rounded-lg py-8 lg:py-32">
      ...
      <Image
        ...
        className="w-full sm:w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 md:-ml-4 lg:-ml-0"
        width={1024}
        height={1149}
        unoptimized
      />
